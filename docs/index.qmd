...
::: {style="text-align:center;"}
![](./data/neural_ODE_field.jpg){height=300}
:::
...
::: {style="text-align:center;"}
![](./data/neural_ODE_results.jpg){height=300}
:::
...
::: {style="text-align:center;"}
![](./data/deep_unsupervised.jpg){width=1000}
:::

::: {style="text-align:center;"}
![](./data/deep_unsupervised_examples.jpg){width=1000}
:::
