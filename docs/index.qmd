...
$$
\begin{align}
\P(X_t \in dx \, | \, X_0 = x_0) &= \frac{1}{\cZ_t} \int \exp\curBK{-\frac{(x - \alpha_t \, x_0)^2}{2 \sigma_t^2}} \, \pi_{\data}(d x_0)\\
...
$$
\cS(t,x) \; = \; -\E\sqBK{  \blue{ \frac{(x - \alpha_t \, X_0)}{\sigma_t^2}} \mid X_t=x}
$$
...
\begin{align}
x
&= \E[ \alpha_t \, X_0 + \sigma_t \, \bfn \mid X_t = x]\\
&= \alpha_t \, \blue{\widehat{x}_0(t,x)} + \sigma_t \, \green{\widehat{\bfn}(t,x)}
\end{align}
$$
...
\begin{align}
\cS(t,x) 
&= -\frac{x - \alpha_t \, \blue{\widehat{x}_0(t,x)}}{\sigma^2_t}
= -\frac{\green{\widehat{\bfn}(t,x)}}{\sigma_t}
\end{align}
$$
