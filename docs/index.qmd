...
::: {style="text-align:center;"}
![some caption](./data/euler_convergence.png){width=500}
:::
...
* The transition probabilities of a OU process are tractable. We have
$$
\log p_t(x) = \log \int \; \P(X_t \in dx \, | \, X_0 = x_0) \; \pi_{\data}(d x_0)
$$
...
* The tractability of the noising OU process allows us to write the score as
$$
